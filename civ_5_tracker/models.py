...
class Game(models.Model):
    players = models.ManyToManyField(
        Player, through="Participant", related_name="player")
    victor = models.ManyToManyField(
        Player, through="Victor", related_name="winner")
    ...
    def __unicode__(self):
        return u"{} players on a {} {} map".format(
            self.players.all().count(), self.size, self.map_type)
